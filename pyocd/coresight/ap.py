...
class AHB_AP(MEM_AP):
    ...
    def hprot(self, value: int) -> None:
        if self.ap_type in (AP_TYPE_AHB, AP_TYPE_AHB5):
            ...
            _hprot_bit = (value & 0x0040) >> 6          # HPROT[6]
    ...
    # @locked
    # def hnonsec(self, value: int) -> None:
    #     AHB_CSW_HNONSEC_MASK = 0x40000000 # HNONSEC [30]
    #     self._hnonsec = value & (AHB_CSW_HNONSEC_MASK >> CSW_HNONSEC_SHIFT)
    #     self._csw = ((self._csw & ~AHB_CSW_HNONSEC_MASK) | (self._hnonsec << CSW_HNONSEC_SHIFT))
